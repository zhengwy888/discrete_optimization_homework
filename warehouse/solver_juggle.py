    ...
    if Juggle:
        ...
        while running:
            ...
            if ( beneOneTwoSorted[0][1] < beneTwoOneSorted[0][1] ):
                exchangeOne.append(beneOneTwoSorted[0][0])
                sizechange[0] = customerSizes[beneOneTwoSorted[0][0]]
            else:
                exchangeOne.append(beneTwoOneSorted[0][0])
                sizechange[1] = customerSizes[beneTwoOneSorted[0][0]]
            sizetest = []
